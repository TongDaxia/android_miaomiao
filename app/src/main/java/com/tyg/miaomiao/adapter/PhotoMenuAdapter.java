...
public class PhotoMenuAdapter extends RecyclerView.Adapter<PhotoMenuAdapter.ItemViewHolder>
    ...
    public PhotoMenuAdapter(Context context, List<String> ages, AutoLocateHorizontalView recyclerView) {
